  ...
  const projects = [
    {
      ...
      technologies: ['Github pages(hosting)','React', 'JavaScript', 'HTML/CSS','Tailwind CSS'],
      link:'https://sarathkrishna869.github.io/My-Portfolio/',
    },
    {
      id: 2,
      title:'ElectiveMGT',
      description: 'This is ElectiveMGT A WebApp',
      technologies: ['Glitch platform', 'HTML', 'CSS', 'JavaScript', 'MongoDB'],
      link:'https://electivemgt.glitch.me/',
    },
    {  id: 3,
      title: 'Project 3',
